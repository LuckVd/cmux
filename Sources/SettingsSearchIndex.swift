...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "workspace-titlebar", String(localized: "settings.app.showWorkspaceTitlebar", defaultValue: "Show Workspace Title Bar"), "workspace titlebar header pane tabs folder active title"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.workspaceTitlebarVisibility": settingID(for: .app, idSuffix: "workspace-titlebar"),
