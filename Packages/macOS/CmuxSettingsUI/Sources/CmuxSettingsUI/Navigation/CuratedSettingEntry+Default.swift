...
extension Array where Element == CuratedSettingEntry {
    ...
    public static func cmuxDefault(catalog: SettingCatalog) -> [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "workspace-titlebar", title: String(localized: "settings.app.showWorkspaceTitlebar", defaultValue: "Show Workspace Title Bar"), synonyms: "Show Workspace Title Bar app.workspaceTitlebarVisibility workspace titlebar header pane tabs"),
